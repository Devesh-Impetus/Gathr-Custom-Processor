...
public class FPAAAIngress implements CustomProcessor {
    ...
    public Dataset<Row> process(Dataset<Row> dataset) throws Exception {
        Map<String, Map<String, Map<String, String>>> rowKeyToAppTocolumnToColumnValMap = getMessages(dataset.collectAsList());
    ...
    public Map<String, Map<String, Map<String, String>>> getMessages(List<Row> rows) {
